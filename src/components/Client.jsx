            ...
            <div className="bg-white p-4 rounded-lg shadow-lg">
                ...
                <div className="mb-4 flex justify-end">
                    <button
                        ...
                        className="px-3 py-1 bg-blue-500 text-white text-sm rounded-md hover:bg-blue-600 focus:outline-none"
                    >
                        Share Clipboard
                    </button>
                </div>
                ...
                <div className="mt-4 p-3 bg-gray-100 rounded-md text-sm">
                    <p>
                        ...
                        keyboard input. Use the "Share Clipboard" button to send your clipboard content to the host.
                    </p>
                </div>
            </div>
        </div>
